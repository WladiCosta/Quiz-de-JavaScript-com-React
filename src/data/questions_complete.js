const data = [
  { category: "HTML",
  questions: [ { question: "Qual tag cria um parágrafo?",
  ...
  answer: "href", tip: "Hyperlink Reference", },
  
  { question: "As listas não ordenadas tem a tag de:",
  options: ["<ol>", "<ul>", "<li>", "<list>"], answer: "<ul>", },
  ...
  { category: "CSS", questions: [ { question: "Qual regra altera a cor de um elemento?",
  options: ["color", "background-color", "font-size", "transition"],
  answer: "color", tip: "Cor em inglês", },
  ...
  { category: "JavaScript", questions: [ { question: "O que é Vanilla JavaScript?",
